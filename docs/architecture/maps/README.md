...
| Stage 3 research and memory | `docs/stages/stage-3-research-memory.md`, `docs/architecture/agent-runtime.md`, `docs/development-status.md` | `packages/shared/src/index.ts`, `packages/db/src/schema.ts`, `packages/db/src/sqlite.ts`, `packages/core/src/commander-runtime.ts`, `apps/api/src/app.ts` | memory DB/API/Commander tests, redaction tests, stale-source tests, `pnpm verify` |
